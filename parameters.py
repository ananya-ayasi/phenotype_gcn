...
ARG_PARSER.add_argument('--batch_size', default=40, type=int) #200
ARG_PARSER.add_argument('--test_size', default=0.2, type=int)
ARG_PARSER.add_argument('--val_size', default=0.1, type=int)

ARG_PARSER.add_argument('--num_epochs', default=20, type=int) #20
...
# GNN settings
ARG_PARSER.add_argument('--gnn_hidden_dim', default=32, type=int, help="Hidden dimension for GNN layers")
ARG_PARSER.add_argument('--output_dim', default=32, type=int, help="Output dimension for the GNN")
ARG_PARSER.add_argument('--model_type', default='LSTM Attention GNN', type=str, 
                         help="Model type to use. Options: 'LSTM Attention GNN', 'Time-series LSTM', etc.")
